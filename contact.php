        ...
        <form action="">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <input type="text" class="form-control pt-3" id="firstName">
                    <label for="lastName" class="form-label pt-3">Last Name</label>
                    <input type="text" class="form-control pt-3" id="lastName">
                    <label for="email" class="form-label pt-3">Email address</label>
                    <input type="email" class="form-control pt-3" id="emailInput">
                        <div class="form-text">We'll never share your email with anyone else.</div>                    
                </div>
                <div class="col-lg-6">
                    <label for="inquiry" class="form-label pt-3">Inquiry</label>
                    
                    <textarea id="inquiry" cols="30" rows="10" class="form-control"></textarea>
                </div>
            </div>
...
<div class="modal fade text-dark" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      BrewBQ operates the Website Name website, which provides the SERVICE.
